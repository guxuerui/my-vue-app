  ...
  <main class="page-content">
    <div class="card" v-for="(item, index) in cards" :key="index">
      <div class="content">
        ...
        <a class="btn" :href="getPagePath(item)" target="_blank">{{ item.button }}</a>
      </div>
    </div>
  </main>
</template>
...
import http from '@/http/request';
  ...
  const getPagePath = (item: any) => {
    ...
    return `http://htmlpreview.github.io/?https://github.com/guxuerui/example-html-css/blob/main/${res.name}/index.html`;
  }
